...
def process_allennlp_format(file, gold = False):
    ...
    while line:
        ...
        extraction_dict['arg1'] = {'text': sub, 'words': sub_new}
        extraction_dict['rel'] = {'text': predicate, 'words': predicate.split()}
        extraction_dict['arg2'] = {'text': obj, 'words': obj_new}
        extractions[sentence].append(extraction_dict)
...
def main(arguments):
    ...
    #print("predictions by OIE are: "+str(predictions_by_OIE))
    #for e in predictions_by_OIE:
        #print(str(e)+", extractions are: "+str(predictions_by_OIE[e])+"\n")
    report = ""
...
def eval_system(gold, predictions):
    ...
    for s, reference_tuples in gold.items():
        ...
        #print("predicted tuples are: "+str(predicted_tuples))
        #print(s)
...
at the sentence level. Return scoring metrics."""
    ...
    for i, gt in enumerate(gold):
        ...
        for j, pt in enumerate(predicted):
            ...
            #print(str(gt)+","+str(pt)+", score="+str(scores[i][j])+"\n")
